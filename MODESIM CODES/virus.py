...
def IterateM(M,B,I):
    ...
    for i, me in enumerate(alive):
        # set velocity to zero for first 50 iterations
        if i <= 50:
            temp_velocity = M[me, 2:6].copy()  # store velocity in temp variable
            M[me, 2:6] = [0, 0, 0, 0]
        # move me
        ...
        if I[me,0]<=I[me,1]:
            B[me,1:3] = False, True
        # restore velocity after 100 iterations
        if i == 149:
            M[me, 2:6] = temp_velocity  # restore velocity from temp variable
